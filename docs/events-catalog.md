...
| `prescription.cancelled` | `EventType.PRESCRIPTION_CANCELLED` | `prescriptions` | `patient_timeline` |
| `prescription.issued` | `EventType.PRESCRIPTION_ISSUED` | `prescriptions` | `patient_timeline` |
